...
const pageParameters = [
  ...
  { name: 'mailboxRole', in: 'query', description: '邮箱文件夹角色', schema: { type: 'string', enum: ['inbox', 'sent', 'archive', 'drafts', 'trash', 'junk', 'custom'] } },
    ...
    schemas: {
      ...
      MessageSummary: {
        ...
        properties: {
          ...
          mailboxRole: { type: 'string', enum: ['inbox', 'sent', 'archive', 'drafts', 'trash', 'junk', 'custom'] }, from: { $ref: '#/components/schemas/Address' },
