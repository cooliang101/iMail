...
export function AppTopbar({ sidebarCollapsed, sidebarOpen, search, searchShortcut, searchInputRef, onToggleSidebar, onOpenMobileSidebar, onSearchChange, onNotifications }: {
  sidebarCollapsed: boolean; sidebarOpen: boolean; search: string; searchShortcut: string; searchInputRef: RefObject<HTMLInputElement | null>;
