...
try {
  ...
  if (!backup.ok || backup.schemaVersion !== 13 || backup.fileCount < 3) {
  ...
  if (!restore.ok || !restore.databaseVerified || !restore.integrityManifestVerified || restore.schemaVersion !== 13) {
