...
try {
  ...
  if (!backup.ok || backup.schemaVersion !== 10 || backup.fileCount < 3) {
  ...
  if (!restore.ok || !restore.databaseVerified || !restore.integrityManifestVerified || restore.schemaVersion !== 10) {
