...
const executable = path.resolve('src-tauri', 'target', 'x86_64-pc-windows-msvc', 'release', 'imail.exe');
...
console.log(JSON.stringify({ exitCode: result.code, managedLocalServiceCapable: true }));
