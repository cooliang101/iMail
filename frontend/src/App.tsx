...
import type { ApiGatewayCredential, AppView, ContextTarget, MailNotification, MailParticipant, MessageStats, Notice, ParticipantRole, WorkspaceFolder } from './app-model';
