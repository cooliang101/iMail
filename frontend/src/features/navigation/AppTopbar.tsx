...
export function AppTopbar({ sidebarCollapsed, sidebarOpen, search, searchPlaceholder = '搜索当前范围内的邮件', searchShortcut, searchInputRef, onToggleSidebar, onOpenMobileSidebar, onSearchChange, onNotifications, onAbout }: {
  ...
  return <header className="topbar">
    ...
    <button data-icon-tone="neutral" className="icon-button" title="关于 iMail" aria-label="打开关于 iMail" onClick={onAbout}><Info size={19} /></button>
