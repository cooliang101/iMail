...
export function MessageReader({ message, account, contacts, defaultBodyView, onReply, onForward, onComposeSender, onCloseMobile, onToggleFlag, onArchive, onDelete, onSnooze, onManageLabels, onMarkUnread, onPrevious, onNext, onContextMenu, hasPrevious, hasNext, actionBusy }: {
  message?: Message; account?: Account; contacts: Contact[]; defaultBodyView: MessageBodyView; onReply: () => void; onForward: () => void; onComposeSender: (address: string) => void; onCloseMobile: () => void; onToggleFlag: () => void; onArchive: () => void; onDelete: () => void; onSnooze: () => void; onManageLabels: () => void; onMarkUnread: () => void; onPrevious: () => void; onNext: () => void; onContextMenu?: (message: Message, point: { x: number; y: number }) => void; hasPrevious: boolean; hasNext: boolean; actionBusy: boolean;
}) {
  ...
  const senderContact = contacts.find((contact) => contact.address.toLocaleLowerCase() === message.from.address.toLocaleLowerCase());
